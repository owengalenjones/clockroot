...
export class MarquiseBot extends Bot {
    ...
    private isChallenging: boolean;
    private warriorsToRecruit: number;
    private isOverwhelming: boolean;
    private isBlitz: boolean;
    private isIronWill: boolean;
    ...
    private escalatedDaylight(translate: TranslateService) {
        const actualRecruit = this.isIronWill ? this.warriorsToRecruit * 2 : this.warriorsToRecruit;

        return [
            this.createMetaData('text', '', translate.instant(`SpecificDaylight.Mechanical Marquise.Bird0`)),
            this.isOverwhelming
                ? this.createMetaData('text', '', translate.instant(`SpecificDaylight.Mechanical Marquise.Bird1Overwhelming`, {
                    splitWarriorsToRecruit: (actualRecruit / 2),
                    totalWarriorsToRecruit: actualRecruit
                }))
                : this.createMetaData('text', '', translate.instant(`SpecificDaylight.Mechanical Marquise.Bird1`, {
                    splitWarriorsToRecruit: (actualRecruit / 2),
                    totalWarriorsToRecruit: actualRecruit
                })),
            this.isChallenging
                ? this.createMetaData('text', '', translate.instant(`SpecificDaylight.Mechanical Marquise.BirdChallenging`))
                : this.createEmptyText(),
            this.createMetaData('text', '', translate.instant(`SpecificDaylight.Mechanical Marquise.Bird2`)),
            this.createMetaData('text', '', translate.instant(`SpecificDaylight.Mechanical Marquise.Bird3`)),
            this.isBlitz
                ? this.createMetaData('text', '', translate.instant(`SpecificDaylight.Mechanical Marquise.Blitz`))
                : this.createEmptyText()
        ];
    }
    ...
    public daylight(translate: TranslateService) {
        ...
        return [
            this.createMetaData('text', '', translate.instant(`SpecificDaylight.Mechanical Marquise.Suit0`, {suit})),
            this.isOverwhelming
                ? this.createMetaData('score', 1, translate.instant(`SpecificDaylight.Mechanical Marquise.Suit1Overwhelming`, {
                    totalWarriorsToRecruit: this.warriorsToRecruit,
                    suit
                }))
                : this.createMetaData('text', '', translate.instant(`SpecificDaylight.Mechanical Marquise.Suit1`, {
                    totalWarriorsToRecruit: this.warriorsToRecruit,
                    suit
                })),
            this.isChallenging
                ? this.createMetaData('text', '', translate.instant(`SpecificDaylight.Mechanical Marquise.SuitChallenging`, {suit}))
                : this.createEmptyText(),
            this.createMetaData('text', '', translate.instant(`SpecificDaylight.Mechanical Marquise.Suit2`, {building})),
            this.createMetaData('text', '', translate.instant(`SpecificDaylight.Mechanical Marquise.Suit3`, {suit})),
            this.isBlitz
                ? this.createMetaData('text', '', translate.instant(`SpecificDaylight.Mechanical Marquise.Blitz`))
                : this.createEmptyText(),
            this.isOverwhelming
                ? this.createMetaData('text', '', translate.instant(`SpecificDaylight.Mechanical Marquise.RepeatOverwhelming`))
                : this.createMetaData('text', '', translate.instant(`SpecificDaylight.Mechanical Marquise.Repeat`))
        ];
    }
    ...
    public evening(translate: TranslateService) {
        ...
        return [
            isNightmare
                ...
                : this.createMetaData('score', score, translate.instant('SpecificEvening.Mechanical Marquise.Score')),
            this.createMetaData('text', '', translate.instant('SpecificEvening.Mechanical Marquise.Discard'))
        ];
    }

    private eveningBird(translate: TranslateService, buildings: { [key: string]: string[] }, isNightmare: boolean) {
